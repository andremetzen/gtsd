...
echo "Test #8 - reverse 1000 with length of 100 strings with Gtsd (2 server, 2 worker)"
...
echo "Running..."
/usr/bin/time -f "Elapsed time: %E" ./reverse_with_gtsd.php localhost:8124,localhost:8125 strings_100.txt > /dev/null 
